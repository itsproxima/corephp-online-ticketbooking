<?php 
           	 session_start();
           	 //$_SESSION["$ticket_price"];
	         //echo  $_SESSION["date"]
	         //echo $_SESSION["ticket_price"];
	         
	        if($_SESSION["typevar"]==1){
...
<head>
 ...
 <div >
    ...
    <div class="register-form">
      <form action="personaldetail.php"  method="post">
         <div>
           	

           </div>
        
          <!-- <h3 class="fs-subtitle"> If you are coming with accompanying person else skip</h3>
           
              <div class="fields-grid">
              <div class="styled-input">
                <span class="fa fa-user" aria-hidden="true"></span>
                <input type="text" placeholder="Name of the person" name="acompany-per-name" >
             </div>
             <div class="styled-input">
                <span class="fa fa-user" aria-hidden="true"></span>
            ...
            <input type="email" placeholder="Your E-mail" name="acompany-per-email">
            </div>
            <div class="styled-input">
              <span class="fa fa-phone" aria-hidden="true"></span>
              <input type="text" placeholder="Phone Number" name="acompany-per-phone">
            </div>
          </div>-->
    
            <h2 class="fs-title">Kindly Enter Your Personal Details</h2>
    <h3 class="fs-subtitle"></h3>
  

          <div class="fields-grid1">
          <div class="styled-input">
            <span class="fa fa-user" aria-hidden="true"></span>
           ...
           <div class="styled-input">
            <span class="fa fa-user" aria-hidden="true"></span>
            <input type="text" placeholder="Sur Name" name="surname" required="">
          </div>
           <div class="styled-input">
            <span class="fa fa-envelope-o" aria-hidden="true"></span>
          ...
          <div class="styled-input">
            ...
            <input type="text" placeholder="KMC Reg Number" name="kmcR-no" required="">
          </div>
          <div class="styled-input">
            <span class="fa fa-id-badge" aria-hidden="true"></span>
            <input type="text" placeholder="KOA Life Membership Number" id="<? echo $checkvar;  ?>" name="koaMembership-no" >
          </div>
          
          <!--<div class="styled-input">
            <span class="fa fa-calendar" aria-hidden="true"></span>
            <input id="datepicker" placeholder="Date" name="date" type="text" value="" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}"
                required="">
          </div>-->
      </div>
            ...
            <div class="styled-input">
              <textarea name="address" placeholder="Postal Address" title="Please enter your Address" required=""></textarea>
            </div>
            <div class="styled-input">
            ...
            <div class="styled-input">
              <input type="text" name="state" placeholder="State" title="Please enter your State name" required="">
            </div>
            <div class="styled-input">
              <input type="text" name="country" placeholder="Country" title="Please enter your Country name" required="">
            </div>
          
          <div class="clear"> </div>
          <input name="submit" type="submit" onclick="validateKoa()" value="Submit">
           </form> 
        </div>
...
<!-- js -->
  ...
  <script>
    function f1(){
      document.getElementById("res-selector").disabled = true;
      document.getElementById("residential").disabled = true;
    }
    function f2(){
      document.getElementById("nonres-selector").disabled = true;
      document.getElementById("nonresidential").disabled = true;
    }
  </script>
  <script>
     
  function validateKoa(){
       var myEle = document.getElementById("koalifereq");
    if(myEle){
        myEle.required = true;
    }
    else{
      myEle.required = false;  
    }
